...
################################################################################
## Form generated from reading UI file 'interface_22_modern_tutorialKHEWwj.ui'
##
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/feather-WHITE/list.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/feather-WHITE/printer.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/feather-WHITE/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/feather-WHITE/info.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/feather-WHITE/help-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
